...
namespace AbsoluteZero {
    ...
    static class Elo {
        ...
        public static Double[] GetError(Double z, Int32 wins, Int32 losses, Int32 draws) {
            ...
            Double lower = GetDelta(Math.Max(0, p - z * se));
            Double upper = GetDelta(Math.Min(1, p + z * se));
